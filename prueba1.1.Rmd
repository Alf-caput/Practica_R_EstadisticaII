...
id: es un identificador de los pacientes sobre los que se está realizando el estudio.
gender: hace referencia al sexo de los pacientes.
age: representa la edad, en años, de los pacientes.
hypertension: variable binaria que representa si el paciente tiene hipertensión (1) o no (0).
heart_disease: indica si el paciente ha tenido previamente problemas cardiacos.
ever_married: indica si el paciente se ha casado o no.
work_type: tipo de trabajo, clasificado de la siguiente forma: Govt_job (funcionario), Private (trabajador del sector privado), Self-employed (autónomo), Never_worked (sin ningún tipo de experiencia laboral) y children (niño y, por tanto, sin experiencia laboral).
...
avg_glucose_level: nivel de glucosa media del paciente medida en mg/dL
bmi: índice de masa corporal del paciente
smoking_status: hábito de consumo de tabaco del paciente, clasificado de la siguiente forma: smokes (fumador actual), formerly smoked (fumador en el pasado) y never smoked (nunca ha fumado)
stroke: variable binaria que indica si el paciente ha tenido un ataque cardiaco (1) o no (0).
